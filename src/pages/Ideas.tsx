...
import IdeaSubmissionForm from '../components/AIAssistant/IdeaSubmissionForm';
import EmergencyAnnouncements, {
  EmergencyAnnouncement,
} from '../components/AIAssistant/EmergencyAnnouncements';
...
const Ideas: React.FC = () => {
  ...
  // Voting state - reserved for future voting implementation
  // const [userVotes, setUserVotes] = useState<
  //   Record<string, 'up' | 'down' | null>
  // >({})
  const [showIdeaForm, setShowIdeaForm] = useState(false);

  // Mock emergency announcements - in production, these would come from an API
  const [emergencyAnnouncements] = useState<EmergencyAnnouncement[]>([
    {
      id: '1',
      type: 'typhoon',
      severity: 'high',
      ...
      description:
        'Tropical Storm approaching Northern Luzon. Expected to make landfall within 24 hours.',
  ...
  // Voting functionality - commented out for future implementation
  ...
  const handleIdeaSubmission = (
    ...
    alert(
      'Idea submitted successfully! In production, this would be saved to the database.'
    );
  };
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='container mx-auto px-4 py-6 md:py-12'>
        ...
        <EmergencyAnnouncements announcements={emergencyAnnouncements} />
      ...
      {/* AI Assistant Idea Submission Form */}
      {showIdeaForm && (
        <IdeaSubmissionForm
          existingIdeas={projectIdeas}
