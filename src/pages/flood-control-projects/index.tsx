      ...
      <ResponsiveContainer width='100%' height='100%'>
        <PieChart>
          <Pie
            ...
            dataKey='Projects'
            nameKey='name'
            label={({ Projects, percent }) =>
              `${Projects} (${(percent * 100).toFixed(1)}%)`
            }
            labelLine={true}
          >
...
const TypeOfWorkChart: React.FC = () => {
  ...
  if (isFiltered) {
    ...
    // Use pre-loaded data for better initial performance
    chartData = typeOfWorkData.TypeofWork.sort((a, b) => b.count - a.count)
      .slice(0, 10)
      .map(item => ({
        value:
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6'>
                ...
                <div className='bg-white rounded-lg shadow-md p-4 mt-8'>
                  ...
                  <p className='text-gray-800 mb-4'>
                    This dashboard visualizes flood control infrastructure
                    projects across the Philippines. The data includes
                    information about project locations, types, implementing
                    offices, and more. Use the filters in the sidebar to explore
                    specific aspects of the data or use the search functionality
