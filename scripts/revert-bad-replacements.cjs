...
for (const filePath of files) {
  try {
    ...
    content = content.replace(/flood-control-projects-contractors&apos;/g, 'flood-control-projects-contractors\'');
    content = content.replace(/All Projects&apos;/g, 'All Projects\'');
    content = content.replace(/Flood Control Projects&apos;/g, 'Flood Control Projects\'');
    content = content.replace(/All Flood Control Projects&apos;/g, 'All Flood Control Projects\'');
    ...
    // Fix specific paths
    content = content.replace(/\/government\/departments&apos;/g, '/government/departments\'');
    content = content.replace(/\/travel\/visa-types&apos;/g, '/travel/visa-types\'');
    content = content.replace(/\/philippines\/regions&apos;/g, '/philippines/regions\'');
    content = content.replace(/\/join-us&apos;/g, '/join-us\'');
    content = content.replace(/\/ideas&apos;/g, '/ideas\'');
    content = content.replace(/bettergov.ph\/ideas&apos;/g, 'bettergov.ph/ideas\'');
    content = content.replace(/bettergov.ph\/join-us&apos;/g, 'bettergov.ph/join-us\'');
    ...
    content = content.replace(/Government Websites Directory/g, 'Government Websites Directory');
    content = content.replace(/Philippines&apos;/g, 'Philippines\'');
    content = content.replace(/About the Philippines&apos;/g, 'About the Philippines\'');
    content = content.replace(/Visa Information/g, 'Visa Information');
    content = content.replace(/Foreign Exchange Rates&apos;/g, 'Foreign Exchange Rates\'');
    content = content.replace(/Flood Control Projects&apos;/g, 'Flood Control Projects\'');

    // Fix category/type names
    content = content.replace(/category: 'Business&apos;/g, 'category: \'Business\'');
    ...
    content = content.replace(/Infrastructure & Tools&apos;/g, 'Infrastructure & Tools\'');
